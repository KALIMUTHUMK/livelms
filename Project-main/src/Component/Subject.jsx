                    ...
                    <table className="min-w-full divide-y divide-gray-200 relative ">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            <tr className="border-b border-gray-200">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">Network Security</td>
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">Arun</td>
