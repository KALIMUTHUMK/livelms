                    ...
                    <table className="min-w-full divide-y divide-gray-200 relative ">
                        <thead className="h-[45px]  align-middle">
                            <tr>
                                ...
                                <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Faculty Name</th>
                                <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Faculty ID</th>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            <tr className="border-b border-gray-200">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">Raj</td>
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">UIT123</td>
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">faculty@gmail.com</td>
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">8687848911</td>
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">04/02/2022</td>
