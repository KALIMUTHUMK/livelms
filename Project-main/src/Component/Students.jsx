        ...
        <table className="min-w-full divide-y divide-gray-200 relative ">
          <thead className="h-[45px]  align-middle">
            <tr>
              ...
              <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Student ID</th>
              <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Student Name</th>
              <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Admission No.</th>
              ...
              <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Section</th>
              <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Email ID</th>
              <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>D.O.B</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr className="border-b border-gray-200">
              ...
              <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">ITT21</td>
              <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">Selva</td>
              <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">210281</td>
              <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">Information Technology</td>
              <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">8687848911</td>
              <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">A</td>
              <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">test@gmail.com</td>
              <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">04/02/2002</td>
