        ...
        <>
         <div className="w-[84%] h-16  fixed top-[100px] left-[16%]" style={{ transform: "translateY(-50%)" }}>
                <div className=" overflow-auto  ">
                    <p>Home <span className="border-r border-amber-300 border-2 h-4 mx-2  " ></span><span className=" text-amber-300">Section</span></p>
                    <div className="flex justify-end  items-center space-x-2 p-4">
                        ...
                        <button type="button" class="text-white bg-[#105D50] hover:bg-yellow-400 font-medium rounded-lg text-sm px-5 py-2.5   ">Add Section</button>
                        <MdUpload />
                        <BiSolidDownload />
                    </div>
                    <table className="min-w-full divide-y divide-gray-200 relative ">
                        <thead className="h-[45px]  align-middle">
                            <tr>
                                ...
                                <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Section ID</th>
                                <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Section Name</th>
                                <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Mentor Faculty ID</th>
                                <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Total Semester</th>
                                <th className=" font-normal text-white bg-[#105D50]  space-x-6" style={{ whiteSpace: 'nowrap' }}>Current Semester</th>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            <tr className="border-b border-gray-200">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">U20ESIT</td>
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">Information  Technology</td>
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">ABC123</td>
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">Sec A </td>
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">ABC123</td>
                                <td className="px-6 py-4 whitespace-nowrap border-r border-gray-200">8</td>
